...
name: agent-builder
description: Build high-performing agents end-to-end. Use when you want to design a new agent (persona + operating rules) and generate the required agent workspace files (SOUL.md, IDENTITY.md, AGENTS.md, USER.md, HEARTBEAT.md, optional MEMORY.md + memory/YYYY-MM-DD.md). Also use to iterate on an existing agent's behavior, guardrails, autonomy model, heartbeat plan, and skill roster.
---

# Agent Builder

Design and generate a complete **Agent Workspace** with strong defaults and advanced-user-oriented clarifying questions.

## Canonical references

- Workspace layout + heartbeat rules: **Read** \`references/Agent-workspace.md\`
...
Generate these files (minimum viable agent):
